                                                            ...
                                                            <form action="?quanly=giohang" method="post">
                                                                <fieldset>
                                                                    ...
                                                                    <input type="hidden" name="giasanpham"
                                                                           value="<?php echo $row_sanpham['sanpham_giakhuyenmai'] ?>"/>
                ...
                <div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
                    <div class="side-bar p-sm-4 p-3">
                        ...
                        <div class="range border-bottom py-2">
                            <h3 class="agileits-sear-head mb-3">Lọc sản phẩm theo giá </h3>
                            <div class="w3l-range">
                                <ul>
                                    <li>
                                        <a href="index.php?quanly=timkiemtheogia&gia0=0&gia=3000000">Dưới 3 triệu</a>
                                    </li>
                                    <li>
                                        <a href="index.php?quanly=timkiemtheogia&gia0=3000000&gia=6000000">Từ 3-6
                                            triệu</a>
                                    </li>
                                    <li>
                                        <a href="index.php?quanly=timkiemtheogia&gia0=6000000&gia=10000000">Từ 6-10
                                            triệu</a>
                                    </li>
                                    <li>
                                        <a href="index.php?quanly=timkiemtheogia&gia0=10000000&gia=10000000">Trên 10
                                            triệu</a>
                                    </li>
                                    ...
                                    while ($row_sanpham_sidebar = mysqli_fetch_array($sql_product_sidebar)) {
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                                <img src="images/<?php echo $row_sanpham_sidebar['sanpham_image'] ?>"
                                                     alt="" class="img-fluid">
                                            </div>
