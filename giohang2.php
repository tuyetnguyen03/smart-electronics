...
if (isset($_POST['themgiohang'])) {
    ...
    return header("Location: /index.php?quanly=thanhtoan");
}
?>
                    ...
                    <table class="timetable_sub" style="border-left: 1px solid black;">
                        ...
                        <tr>
                            <td colspan="7"><input type="submit" class="btn btn-success" value="Cập nhật giỏ hàng"
                                                   name="capnhatsoluong">
                                <input type="submit" class="btn btn-primary" href="#billing-address"
                                       value="Thanh toán giỏ hàng" name="thanhtoandangnhap">
                                <?php
