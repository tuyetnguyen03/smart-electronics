...
if (isset($_POST['themgiohang'])) { //tồn tại khi ấn thêm giỏ hàng
    ...
    for ($i = 0; $i < count($_POST['thanhtoan_product_id']); $i++) { //chạy từ i=0 đến hết sản phẩm thanh toán
        ...
        $sql_donhang = mysqli_query($con, "INSERT INTO tbl_donhang(sanpham_id,khachhang_id,soluong,mahang) values ('$sanpham_id','$khachhang_id','$soluong','$mahang')"); //lần lượt insert vào bảng đơn hàng
        $sql_giaodich = mysqli_query($con, "INSERT INTO tbl_giaodich(sanpham_id,soluong,magiaodich,khachhang_id) values ('$sanpham_id','$soluong','$mahang','$khachhang_id')");  //lần lượt thêm vào bảng giao dịch note: mã giao dịch=mã hàng
    ...
    <div>
                        ...
                        <div class="table-responsive">
                            <form action="" method="POST">
                                ...
                                <table class="timetable_sub" style="border-left: 1px solid black;">
                                        ...
                                        <tr class="rem1">
                                            ...
                                            <td class="invert-image">
                                                ...
                                                <img src="images/<?php echo $row_fetch_giohang['hinhanh'] ?>" alt=" "
                                                     class="img-responsive" style="height: 110px;object-fit: contain;">
                                    ...
                                    ?>
                                    <tr>
                                        <td class="total-price" colspan="7">Tổng tiền
                                            : <?php echo number_format($total) . 'vnd' ?></td>

                                    </tr>
                                    <tr>
                                        <td class="total-price" colspan="7"><a href="index.php?quanly=giohang">Chỉnh sửa
                                                đơn hàng</td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <div class="checkout-left">
            ...
            <div class="address_form_agile">
                <form method="POST" action="index.php?quanly=thuchienthanhtoan" enctype="multipart/form-data"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text"
                                                               value="<?php echo $row['name']; ?> " name="txtHovaten"
                                                               placeholder="Họ và tên" readonly="true">
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text"
                                                               value="<?php echo $row['phone']; ?>" readonly="true">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label>Địa chỉ người đặt</label>
                                                        <input class="form-control" type="text"
                                                               value="<?php echo $row['address']; ?>" readonly="true"
                                                               style="height: 100px;">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="billing-address">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input class="form-control " type="text" id="txtHovaten"
                                                                       name="txtHovaten" placeholder="Họ và tên">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label>Điện thoại người nhận</label>
                                                                <input class="form-control" type="text"
                                                                       id="txtSodienthoai" name="txtSodienthoai"
                                                                       placeholder="Số điện thoại">
                                                            </div>
                                                            <div class="col-md-12">
                                                                <label>Địa chỉ người nhận</label>
                                                                <input class="form-control" type="text" id="txtDiachi"
                                                                       name="txtDiachi"
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <input class="form-control" type="text" id="txtEmail"
                                                                       name="txtEmail" placeholder="Email người nhận">
                                                            </div>
                                                            <div class="col-md-12">
                                                                <label>Ghi chú</label>
                                                                <textarea class="form-control" type="text"
                                                                          id="txtGhichu" name="txtGhichu"
                                                                          placeholder="Mời nhập ghi chú nếu cần"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div colspan="2">
                                                        <div class="checkout-btn"
                                                             style="align-content: center; padding-left: 50%; padding-top: 40px;">
